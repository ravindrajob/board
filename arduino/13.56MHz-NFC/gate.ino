...
void loop()
{
	...
	if (status == MI_OK)
	{
          ...
          Serial.print("Calculated Checksum:\t");
            ...
            // If CODE prototype002 DETECTED
            if((str[0] == 96) &&  (str[1] == 113) && (str[2] == 209) && (str[3] == 160))  //You can change this to the first byte of your tag by finding the card's ID through the Serial Monitor
            {
              Serial.print("prototype002 CODE DETECTED");
